...
export default function ReportDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <PageShell eyebrow="Report details" title="Development activity report" description="Review activity facts and code-analysis findings."><ReportDetailView reportId={id} loadReport={getReport} saveRevision={saveRevision} regenerateReport={regenerate} downloadArtifact={downloadReportArtifact} resolveContributorLabels={resolveReportContributorLabels} /></PageShell>;
}
